...
main {
    ...
    margin-bottom: 40px;
        ...
        #row {
    position: relative;
    width: 100%; /* Adjusted width to take up full space */
    margin-bottom: 20px; /* Added margin bottom to create space between sections */
}
...
#row ul li {
    margin-bottom: 10px; /* Added margin bottom to create space between questions */
    font-size: 14px;
    margin-bottom: 60px;
}
...
#row ul li strong {
    font-weight: bold;
    display: block; /* Ensure strong tag displays as block to separate question from answer */
}
                    ...
                    <div id="row">
                        ...
                        <ul>
                            <li><strong>What payment methods do you accept?</strong><br>
                                We accept all credit and debit cards including PayPal and Clearpay.</li>
                            <li><strong>Do you ship internationally?</strong><br>
                                Yes! We currently ship to a variety of countries.</li>
                            <li><strong>How can I track my order?</strong><br>
                                The status of your order can be viewed on the order details page.</li>
                        </ul>
                    </div>
                    <div id="row">
                        <h4>PRODUCT INFORMATION</h4>
                        <ul>
                            <li><strong>Are your sunglasses polarized?</strong><br>
                                Yes, all our sunglasses have polarized lenses to provide maximum protection from UV rays.</li>
                            <li><strong>What materials are used in your sunglasses?</strong><br>
                                Our sunglasses frames are made from titanium and stainless steel. We ensure to use the highest quality materials.</li>
                            <li><strong>Do you offer prescription sunglasses?</strong><br>
                                No, we do not currently offer prescription sunglasses.</li>
                        </ul>
                    </div>
                    <div id="row">
                        ...
                        <ul>
                            <li><strong>What is your return policy?</strong><br>
                                If you are not satisfied with your purchase, you can return your sunglasses within 30 days for a full refund.</li>
                            <li><strong>How do I return my order?</strong><br>
                               Please visit the order history page where there will be an option to return your order.</li>
                            <li><strong>Do you offer exchanges?</strong><br>
                                Yes, we offer exchanges as long as the product is in the original condition. The value must be the same or if lesser or more, this will need to be adjusted.</li>
                        </ul>
                    </div>
                </div>
            </div>
