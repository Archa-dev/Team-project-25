...
<head>
    ...
    <title>Terms and Conditions - SHADED</title>
    <style>
...
#section h4 {
    margin-bottom: 10px;
    color: #003B46; /*margin bottom to create space between title and questions */
    margin-bottom: 40px;
   font-weight: bold;
...
<header>
        <!-- bootstrap navbar utility classes -->
...
//  initial position of the sun icon below the navbar
