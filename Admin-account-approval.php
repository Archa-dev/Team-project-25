...
<html lang="en">
    <head>
        ...
        <title>Admin Approval - Admin</title>
...
/* CSS for the approve and refuse buttons */
.button-container {
    justify-content: center;
}
...
."<form action='Admin-account-approval.php' method='post'>"
."<button type='submit' class='button approve-button' name='data_link' data-link='$details'>Approve</button>"
."<input type='hidden' name='data_link' value='$details'>"
."</form>"
."<form action='Admin-account-approval.php' method='post'>"
."<button type='submit' class='button refuse-button' name='data_link2' data-link='$details'>Refuse</button>"
."<input type='hidden' name='data_link2' value='$details'>"
."</form>"
."</td>
</tr>");
}
