...
.main-content {
        ...
        .main-content video {
        width: 100%; /* Sets video width to fill the container fully */
        height: auto; /* Automatically adjusts height to maintain aspect ratio */
    }

        .text-overlay {
            position: absolute;
            top: 30px; /* Adjusts the top value to control the distance from the top */
            left: 30px; /* Adjusts the left value to control the distance from the left */
            text-align: left;
            color: #fff; 
        }
...
.col-md-6:nth-child(1) .video-container .text-overlay {
    left: 30px; /*distance from the left for the first column */
    top: 30px;
}
