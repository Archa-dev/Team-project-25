...
<a href="basket.php" class="return-link"><i class="fas fa-arrow-left"></i> Return to Shopping Bag</a>
    ...
    <div class="col-12 col-md-6 mb-4">
        ...
        <button type="button" onclick="validateShipping()" class="confirm">CONFIRM</button>
    </form>
        ...
        <button type="button" onclick="validatePayment()" class="confirm">CONFIRM</button>
    </form>
